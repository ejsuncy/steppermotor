...
var Label = (function (_super) {
    ...
    Label.prototype[text_base_1.whiteSpaceProperty.getDefault] = function () {
        return text_base_1.WhiteSpace.NO_WRAP;
    };
    Label.prototype[text_base_1.whiteSpaceProperty.setNative] = function (value) {
        var nativeView = this.nativeView;
        switch (value) {
            case text_base_1.WhiteSpace.NORMAL:
                nativeView.lineBreakMode = 0;
                nativeView.numberOfLines = 0;
                break;
            case text_base_1.WhiteSpace.NO_WRAP:
                nativeView.lineBreakMode = 4;
                nativeView.numberOfLines = 1;
                break;
            default:
                throw new Error("Invalid whitespace value: " + value + ". Valid values are: \"" + text_base_1.WhiteSpace.NORMAL + "\", \"" + text_base_1.WhiteSpace.NO_WRAP + "\".");
        }
    };
    ...
    Label.prototype[text_base_1.backgroundInternalProperty.setNative] = function (value) {
        if (value instanceof background_1.Background) {
            var uiColor = background_2.ios.createBackgroundUIColor(this, true);
            value = uiColor ? uiColor.CGColor : null;
        }
        this._setNativeClipToBounds();
        this.nativeView.layer.backgroundColor = value;
    };
    Label.prototype[text_base_1.borderTopWidthProperty.getDefault] = function () {
        return zeroLength;
    };
    ...
    Label.prototype[text_base_1.borderRightWidthProperty.getDefault] = function () {
        return zeroLength;
    };
    ...
    Label.prototype[text_base_1.borderBottomWidthProperty.getDefault] = function () {
        return zeroLength;
    };
    ...
    Label.prototype[text_base_1.borderLeftWidthProperty.getDefault] = function () {
        return zeroLength;
    };
    ...
    Label.prototype[text_base_1.paddingTopProperty.getDefault] = function () {
        return zeroLength;
    };
    ...
    Label.prototype[text_base_1.paddingRightProperty.getDefault] = function () {
        return zeroLength;
    };
    ...
    Label.prototype[text_base_1.paddingBottomProperty.getDefault] = function () {
        return zeroLength;
    };
    ...
    Label.prototype[text_base_1.paddingLeftProperty.getDefault] = function () {
        return zeroLength;
    };
