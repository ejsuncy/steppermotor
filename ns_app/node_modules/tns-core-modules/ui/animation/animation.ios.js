...
var Animation = (function (_super) {
    ...
    Animation._getNativeAnimationArguments = function (animation, valueSource) {
        var nativeView = animation.target.nativeView;
...
function _getTransformMismatchErrorMessage(view) {
    ...
    result = CGAffineTransformTranslate(result, style_properties_1.Length.toDevicePixels(view.translateX || 0, 0), style_properties_1.Length.toDevicePixels(view.translateY || 0, 0));
    ...
    var nativeTransform = NSStringFromCGAffineTransform(view.nativeView.transform);
