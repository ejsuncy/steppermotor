...
var TextBase = (function (_super) {
    ...
    TextBase.prototype.setFormattedTextDecorationAndTransform = function () {
        ...
        if (this.nativeView instanceof UIButton) {
            this.nativeView.setAttributedTitleForState(attrText, 0);
        }
        else {
    ...
    TextBase.prototype.setTextDecorationAndTransform = function () {
        ...
        var isTextView = this.nativeView instanceof UITextView;
        ...
        if (dict.size > 0 || isTextView) {
            ...
            if (this.nativeView instanceof UIButton) {
                this.nativeView.setAttributedTitleForState(result, 0);
            }
            else {
            ...
            if (this.nativeView instanceof UIButton) {
                this.nativeView.setAttributedTitleForState(null, 0);
                this.nativeView.setTitleForState(source, 0);
            }
            else {
    ...
    TextBase.prototype.createMutableStringForSpan = function (span, text) {
        var viewFont = this.nativeView.font;
        var attrDict = {};
