...
var View = (function (_super) {
    ...
    View.prototype.updateNativeTransform = function () {
        var translateX = style_properties_1.Length.toDevicePixels(this.translateX || 0, 0);
        var translateY = style_properties_1.Length.toDevicePixels(this.translateY || 0, 0);
    ...
    View.prototype[style_properties_1.backgroundInternalProperty.setNative] = function (value) {
        ...
        if (value instanceof UIColor) {
            ...
            this.nativeView.backgroundColor = background_1.ios.createBackgroundUIColor(this);
