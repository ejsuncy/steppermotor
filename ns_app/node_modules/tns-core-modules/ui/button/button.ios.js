...
var Button = (function (_super) {
    ...
    Button.prototype[button_common_1.whiteSpaceProperty.getDefault] = function () {
        return button_common_1.WhiteSpace.NO_WRAP;
    };
    Button.prototype[button_common_1.whiteSpaceProperty.setNative] = function (value) {
        var nativeView = this.nativeView.titleLabel;
        switch (value) {
            case button_common_1.WhiteSpace.NORMAL:
                nativeView.lineBreakMode = 0;
                nativeView.numberOfLines = 0;
                break;
            case button_common_1.WhiteSpace.NO_WRAP:
                nativeView.lineBreakMode = 5;
                nativeView.numberOfLines = 1;
                break;
            default:
                throw new Error("Invalid whitespace value: " + value + ". Valid values are: \"" + button_common_1.WhiteSpace.NORMAL + "\", \"" + button_common_1.WhiteSpace.NO_WRAP + "\".");
        }
    };
    ...
    Button.prototype[button_common_1.textAlignmentProperty.getDefault] = function () {
...
Button.nativeToJsTextAlignment = (_a = {},
    _a[1] = "left",
    _a[0] = "center",
    _a[2] = "right",
    _a[3] = "center",
    _a);
Button.jsToNativeTextAlignment = {
    "left": 1,
    "center": 0,
    "right": 2
};
